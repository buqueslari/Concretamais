(() => {
  function a(a, e, i, r) {
    Object.defineProperty(a, e, { get: i, set: r, enumerable: !0, configurable: !0 });
  }
  var e =
  ...
  null == t &&
    ...
    t.register("iM5Ye", function (e, i) {
          ...
          return (o) => {
            e.value >= 0 &&
              ...
              (n || void 0 === t) &&
                ...
                (e.delta = n),
                (e.rating = ((a, e) =>
                  a > e[1] ? "poor" : a > e[0] ? "needs-improvement" : "good")(e.value, i)),
                a(e)));
          };
        },
        o = (a) => {
      ...
      class m {
        ...
        h(a) {
          ...
          const e = this.o[0],
            i = this.o.at(-1);
          this.i && e && i && a.startTime - i.startTime < 1e3 && a.startTime - e.startTime < 5e3
            ...
            const a = s(),
              e = document.prerendering
                ...
                : globalThis.performance
                    ...
                    .filter((e) => "hidden" === e.name && e.startTime > a)[0]?.startTime;
            (g = e ?? f()),
              S(),
              t(() => {
                setTimeout(() => {
              ...
              for (const e of a)
                "first-contentful-paint" === e.name &&
                  ...
                  e.startTime < i.firstHiddenTime &&
                    ((c.value = Math.max(e.startTime - s(), 0)), c.entries.push(e), r(!0)));
            });
            u &&
          ...
          globalThis.PerformanceEventTiming &&
            ...
            y(() => {
              "interactionCount" in performance ||
                k ||
                (k = d("event", B, { type: "event", buffered: !0, durationThreshold: 0 }));
              let i,
                r = A("INP");
              const o = l(e, L),
                c = (a) => {
                ...
                s = d("event", c, { durationThreshold: e.durationThreshold ?? 40 });
            ...
            const u = l(e, G),
              m = (a) => {
                ...
                for (const e of a)
                  u.h(e),
                    e.startTime < i.firstHiddenTime &&
                      ((c.value = Math.max(e.startTime - s(), 0)), (c.entries = [e]), r());
              },
    ...
    (function () {
        ...
        if (
          (o
            ...
            : n
              ? (t = `${n}/api/tracking`)
              : s
                ? ((s = s.replaceAll(/\/+$/gm, "")), (t = `${s}/v0/events?name=${i}&token=${c}`))
                : (t = `https://api.tinybird.co/v0/events?name=${i}&token=${c}`),
          m)
        ) {
          if (
            ((A = S(e)), (A = Object.assign({}, JSON.parse(A), l)), (A = JSON.stringify(A)), !h(A))
          )
            return;
        } else {
          A = Object.assign({}, e, l);
      ...
      (window.Tinybird = { trackEvent: v }), window.addEventListener("hashchange", y);
